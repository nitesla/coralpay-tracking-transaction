...
public class SwaggerConfig {
    ...
    @Bean
    public Docket coralpayApi() {
        return new Docket(DocumentationType.SWAGGER_2).select()

                .apis(RequestHandlerSelectors.basePackage("com.coralpay"))
                .paths(regex("/*.*")).build()
                .apiInfo(metaData())
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder().title("Coralpay HQ")
                .description("Coralpay Application").version("1.0.0")
                .license("Apache License Version 2.0").licenseUrl("https://www.apache.org/licenses/LICENSE-2.0\"")
                .contact(new Contact("Coralpay HQ", "www.xxxxxxx.com ", "info@xxxxxx.com")).build();
    }
